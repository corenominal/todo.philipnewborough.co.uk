    ...
    <body class="">
        <main class="not-found-wrap">
            <div class="not-found-content text-center">
                <img src="/assets/img/skull.svg" alt="" class="not-found-img" aria-hidden="true">
                <h1 class="glitch fw-bold" data-text="404 Not Found">404 Not Found</h1>
                <p class="lead not-found-lead">The page you are looking for does not exist.</p>

                <a href="<?= config('Urls')->tld ?>" class="not-found-link">Return to Home</a>
            </div>
        </main>
    </body>
</html>
